...
class CalculadoraFatorial:
    def calcular_fatorial(self, n):
        ...
        if n <= 0 or n >= 16:
            raise ValueError("O número deve ser positivo e menor que 16.")
...
def main():
    ...
    try:
        ...
        while continuar:
            ...
            numero = int(input("Digite um número inteiro positivo e menor que 16: "))
            ...
            # Pergunta ao usuário se deseja calcular o fatorial novamente
