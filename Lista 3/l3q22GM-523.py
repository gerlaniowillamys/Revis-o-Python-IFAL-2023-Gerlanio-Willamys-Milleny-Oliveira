...
def main():
    ...
    try:
        ...
        # Cria um objeto da classe VerificadorPrimo
        verificador = VerificadorPrimo()

        if verificador.eh_primo(numero):
            print(f"O número {numero} é primo.")
        else:
            divisores = verificador.encontrar_divisores(numero)
            print(f"O número {numero} não é primo. É divisível por: {divisores}")
