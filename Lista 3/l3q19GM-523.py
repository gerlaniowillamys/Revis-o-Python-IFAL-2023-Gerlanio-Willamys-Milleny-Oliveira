...
# Programa para determinar o menor valor, o maior valor e a soma dos valores de um conjunto de números entre 0 e 1000
...
class AnalisadorConjuntoNumeros:
    ...
    def adicionar_valor(self, valor):
        if valor < 0 or valor > 1000:
            raise ValueError("Valor fora do intervalo permitido (0 a 1000).")
